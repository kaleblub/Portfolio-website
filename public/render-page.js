...
var plugins = [{
  ...
  options: {
    "plugins": [],
    "defaultLayouts": {
      "default": "/home/gaz/Desktop/gatsby/kaleblub.github.io/src/components/layouts/article.js"
    },
    "extensions": [".mdx"],
    "gatsbyRemarkPlugins": [],
    "lessBabel": false,
    ...
    "root": "/home/gaz/Desktop/gatsby/kaleblub.github.io"
  }
}, {
...
const {
  ThemeProvider
} = __webpack_require__(/*! ./src/context/theme-context */ "./src/context/theme-context.js");

const {
  MediaQueryProvider
} = __webpack_require__(/*! ./src/context/media-query-context */ "./src/context/media-query-context.js");

exports.wrapRootElement = ({
  element
}) => {
  return /*#__PURE__*/React.createElement(ThemeProvider, null, /*#__PURE__*/React.createElement(MediaQueryProvider, null, element));
};
...
exports.onRenderBody = ({
  ...
  setPreBodyComponents( /*#__PURE__*/React.createElement(MagicScriptTag, {
    key: "hello-friend-ng-mode"
  }));
};
...
/***/ "./src/context/media-query-context.js":
/*!********************************************!*\
  !*** ./src/context/media-query-context.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _hooks_useMediaQueryMatch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../hooks/useMediaQueryMatch */ "./src/hooks/useMediaQueryMatch.js");


const MediaQueryContext = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createContext();

const MediaQueryProvider = ({
  children
}) => {
  const match = (0,_hooks_useMediaQueryMatch__WEBPACK_IMPORTED_MODULE_1__.default)();
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(MediaQueryContext.Provider, {
    value: match
  }, children);
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MediaQueryContext);
...
/* harmony export */ });
/* harmony import */ var _public_page_data_sq_d_3356079039_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../public/page-data/sq/d/3356079039.json */ "./public/page-data/sq/d/3356079039.json");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _hooks_useModeToggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../hooks/useModeToggle */ "./src/hooks/useModeToggle.js");
...
const ThemeProvider = ({
  ...
  const data = _public_page_data_sq_d_3356079039_json__WEBPACK_IMPORTED_MODULE_0__.data;
  const [currentMode, toggleMode, allowChange] = (0,_hooks_useModeToggle__WEBPACK_IMPORTED_MODULE_2__.default)(data.site.siteMetadata.mode);
...
/***/ "./src/hooks/useMediaQueryMatch.js":
/*!*****************************************!*\
  !*** ./src/hooks/useMediaQueryMatch.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    const handleQueryMatch = () => {
      for (const property of properties) {
        ...
        const query = getComputedStyle(document.body).getPropertyValue(property); // Check if media query matches and update if needed

        if (window.matchMedia(query).matches) {
          if (property !== match.mediaQueryMatch) {
            setMatch({
              mediaQueryMatch: property
            });
          ...
          if (property === "--phoneWidth") {
            ...
            if (match.phoneWidth !== phoneWidth) {
              setMatch(_objectSpread(_objectSpread({}, match), {}, {
                phoneWidth
              }));
            }
          }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useMediaQueryMatch);

/***/ }),

/***/ "./src/hooks/useModeToggle.js":
/*!************************************!*\
  !*** ./src/hooks/useModeToggle.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const useModeToggle = data => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (typeof window !== 'undefined' && !localStorage.getItem("hello-friend-ng-mode") && data.default === "dark") {
      toggleMode();
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useModeToggle);
...
/***/ "./public/page-data/sq/d/3356079039.json":
/*!***********************************************!*\
  !*** ./public/page-data/sq/d/3356079039.json ***!
  \***********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"data":{"site":{"siteMetadata":{"mode":{"default":"dark","allowChange":true}}}}}');

/***/ }),

/***/ "react-dom/server":
/*!***********************************************************************************************!*\
  !*** external "/home/gaz/Desktop/gatsby/kaleblub.github.io/node_modules/react-dom/server.js" ***!
  \***********************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/home/gaz/Desktop/gatsby/kaleblub.github.io/node_modules/react-dom/server.js");;

/***/ }),

/***/ "react":
/*!******************************************************************************************!*\
  !*** external "/home/gaz/Desktop/gatsby/kaleblub.github.io/node_modules/react/index.js" ***!
  \******************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/home/gaz/Desktop/gatsby/kaleblub.github.io/node_modules/react/index.js");;
