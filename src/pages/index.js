...
import ColorThemePicker from '../components/ColorTheme';

// Google Analytics Import
import ReactGA from 'react-ga'
ReactGA.initialize('G-XKKPBJMRNL'); //add tracking id here
...
const IndexPage = () => (
  <Layout>
    ...
    <section id="banner">
      <header>
        <h2>Greetings, I am Kaleb Humpal.</h2>
      </header>
      <p>
        This is my brand new portfolio website, template designed by{' '}
    ...
    <article id="first" className="container box style1 right">
      ...
      <div className="inner">
        ...
        <p>
          Follow my journey of starting fresh with my website(this website). <br/>
          Learn from my mistakes and maybe learn something new along the way! <br/>
        </p>
        <a href="#Blog1Link" className="button style2 bloglink">
          Read More
        </a>
      </div>
    </article>
    ...
    <article className="container box style1 left">
      ...
      <div className="inner">
        ...
        <p>
          Come learn some python with me! I talk about Selenium, web scraping,
          and all kinds of fun python stuff. Learn how I make python scrape and 
          play quizes on freerice.com
        </p>
        <a href="#Blog1Link" className="button style2 bloglink">
          Read More
        </a>
    ...
    <article className="container box style3">
      <header>
        ...
        <p>Send me a message or scroll down for my other platforms.</p>
      </header>
